// pages/microConsultation/quesDetail/quesDetail.js
const app=getApp();
Page({
  ...
  goPj:function(e){
    wx.navigateTo({
      url: '../evaluate/evaluate?id=' + e.currentTarget.dataset.id + "&name=" + e.currentTarget.dataset.name + "&dj=" + e.currentTarget.dataset.dj,
    })
  },
