// pages/mine/minePresentation/managePresentationDetail/managePresentationDetail.js
const app = getApp();
...
Page({
    ...
    if (res.from === 'button') {
      ...
      if (this.data.shareName == "zc") {
        return {
          ...
          path: 'pages/share/assessmentZc/assessmentZc?id=' + this.data.shareId + "&uuid=" + app.globalData.userInfo.uuid + "&url=" + app.public.url,
          imageUrl: '../../../../img/share-zc.png'
        }
      } else {
        return {
          title: '您有一份财税政策变动评估单待查看',
          path: 'pages/share/assessmentZcb/assessmentZcb?id=' + this.data.shareId + "&uuid=" + app.globalData.userInfo.uuid + "&url=" + app.public.url,
          imageUrl: '../../../../img/share-zc.png'
        }
      }
    }
  ...
  goEdit:function(e){
    wx.navigateTo({
      url: '../../mineCoach/mineAssessment/mineAssessment?id=' + e.currentTarget.dataset.id,
    })
  },
  ...
  goResult: function (e) {
    wx.navigateTo({
      url: '../../mineCoach/assessmentResult/assessmentResult?id=' + e.currentTarget.dataset.id,
    })
  },
